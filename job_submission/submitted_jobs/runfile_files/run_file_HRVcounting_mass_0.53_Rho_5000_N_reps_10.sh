...
cp ${runfilename::-4}".exe" "executables/HRVs_M${mass}_rho${N_multiplier}_reps${N_reps}.exe"
"./executables/HRVs_M${mass}_rho${N_multiplier}_reps${N_reps}.exe" $mass $N_multiplier $N_reps
