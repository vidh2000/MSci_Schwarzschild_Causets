...
class EmbeddedCauset: public Causet
{
    public:
        ...
        // EMBEDDEDCAUSET_MODIFIERS (BETA: NONE TESTED)
        ...
        // EMBEDDEDCAUSET_INTERVALS

        void get_random_intervals(int min_size, int max_size = 0, 
                                  int N_max = 1000);
